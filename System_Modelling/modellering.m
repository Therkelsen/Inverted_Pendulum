...
A = subs(A, {theta, diff(theta, t), diff(x, t)}, {pi, 0, 0}) % pi = linearisering omkring opretstående punkt
B = subs(B, {theta, diff(theta, t), diff(x, t)}, {pi, 0, 0}) % 0 =linearisering omkring nedadstående punkt
